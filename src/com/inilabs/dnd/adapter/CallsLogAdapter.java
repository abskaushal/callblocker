...
public class CallsLogAdapter extends ArrayAdapter<ContactEntity>{
	...
	public CallsLogAdapter(Context context, int resource,
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
		...
		holder.name.setText(entity.getName()+"("+entity.getType()+")");
